...
const COPY = {
  ...
  heading: 'Se o Que Você Leu Fez',
  headingEm: 'Sentido Para Você',
  subtitle: 'Sua paz não é negociável. O padrão que você repete tem uma causa raiz. Ela pode ser dissolvida. Eu estou aqui para te guiar nesse processo com precisão, embasamento e respeito pela sua história.',
  ctaText: 'Agende sua conversa agora',
}
// ════════════════════════════════════════════════════════════════════
