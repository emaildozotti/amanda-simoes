...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Antes de Qualquer Coisa,',
  headingEm: 'Preciso Te Contar Algo',
  preText: 'Neste vídeo, eu falo sobre o que ninguém te contou a respeito da sua estagnação: por que falar sobre o problema, por anos, não foi suficiente, e o que eu descobri que muda isso de forma permanente.',
  postText: 'O que você acabou de assistir é apenas a superfície. A estrutura por trás dessa mudança tem nome, tem ciência, e tem mais de dez anos de desenvolvimento.',
}
// ════════════════════════════════════════════════════════════════════
