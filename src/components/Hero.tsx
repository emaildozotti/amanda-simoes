...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'PARA QUEM JÁ TENTOU DE TUDO',
  h1: 'Dissolva as Memórias Ocultas que Travam a Sua Vida e Manifeste o Futuro que Você',
  h1Em: 'Já Deveria Estar Vivendo',
  subtitle: 'Você não está presa ao passado por falta de força. Está presa porque ninguém ainda acessou a causa raiz no seu campo vibracional.',
  ctaPrimary: 'Agende sua conversa',
  ctaSecondary: 'Entenda como isso funciona',
}
// ════════════════════════════════════════════════════════════════════
